...
- **Film-chipek** (flex wrap, gap 12px, középre, `min-height: 180px`): az aktív kategória filmjei pill-ként: `padding: 10px 18px`, `border-radius: 100px`, 14px, `rgba(255,255,255,.85)`, `background: rgba(255,255,255,.05)`, `border: 1px solid rgba(255,255,255,.1)`.
